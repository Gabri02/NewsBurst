...
function _getNewsDetails() {
  _getNewsDetails = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(id) {
    var response;
...
var newsIds = await getLatestNewsIds(startIndex, endIndex);
function getLatestNewsIds(_x, _x2) {
  return _getLatestNewsIds.apply(this, arguments);
}
function _getLatestNewsIds() {
  _getLatestNewsIds = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(startIndex, endIndex) {
...
function _loadMoreNews() {
  _loadMoreNews = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
    var newsPerPage, startIndex, endIndex, prevPageBtn, _yield$getLatestNewsI, newsIds, loadedNewsCount, nextIds, loadedNews, _iterator, _step, id, news;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function goToNextPage() {
  var totalPages = Math.ceil(totalNewsCount / 10);
...
function _loadNewsForCurrentPage() {
  _loadNewsForCurrentPage = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {
    var startIndex, endIndex, loadedNews, _iterator2, _step2, id, news, newsDiv, currentPageIndicator, nextPageBtn, totalPages;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          endIndex = startIndex + newsPerPage;
          loadedNews = [];
          _iterator2 = _createForOfIteratorHelper(currentNewsIds);
          _context2.prev = 4;
          _iterator2.s();
        case 6:
        ...
        case 22:
          ...
          totalPages = Math.ceil(totalNewsCount / 10);
          nextPageBtn.disabled = currentPage === totalPages;
        case 30:
        case "end":
