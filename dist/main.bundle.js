...
function getNewsDetails(_x) {
  return _getNewsDetails.apply(this, arguments);
}
function _getNewsDetails() {
  _getNewsDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return axios.get("".concat(apiUrl, "/item/").concat(id, ".json"));
        case 3:
        ...
        case 7:
          ...
          console.error("Errore durante il recupero dei dettagli della notizia con ID ".concat(id, ":"), _context.t0);
...
var _require = __webpack_require__(/*! ./newsDisplay.component */ "./src/js/components/newsDisplay.component.js"),
  displayNewsDetails = _require.displayNewsDetails;
var _require2 = __webpack_require__(/*! ./api.component */ "./src/js/components/api.component.js"),
  getNewsDetails = _require2.getNewsDetails;
var apiUrl = "https://hacker-news.firebaseio.com/v0";
...
function _getLatestNewsIds() {
  _getLatestNewsIds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var newsIds, response, _iterator, _step, id, news;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          newsIds = [];
          _context.prev = 1;
          _context.next = 4;
          return axios.get("".concat(apiUrl, "/newstories.json"));
        case 4:
          response = _context.sent;
          newsIds = response.data.slice(loadedNewsCount, loadedNewsCount + 10);
          _iterator = _createForOfIteratorHelper(newsIds);
          _context.prev = 7;
          _iterator.s();
        case 9:
        ...
        case 28:
          ...
          console.error('Errore durante il recupero degli ID delle ultime notizie:', _context.t1);
        case 31:
    ...
    }, _callee, null, [[1, 28], [7, 19, 22, 25]]);
  }));
  return _getLatestNewsIds.apply(this, arguments);
}
module.exports = {
  getLatestNewsIds: getLatestNewsIds
};

/***/ }),

/***/ "./src/js/components/newsDisplay.component.js":
/*!****************************************************!*\
  !*** ./src/js/components/newsDisplay.component.js ***!
  \****************************************************/
/***/ ((module) => {
...
/***/ "./src/js/components/newsLoad.component.js":
/*!*************************************************!*\
  !*** ./src/js/components/newsLoad.component.js ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
function _loadMoreNews() {
  _loadMoreNews = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$getLatestNewsI, newsIds, loadedNewsCount, nextIds, loadedNews, _iterator, _step, id, news;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          loadMoreBtn.disabled = true;
          _context.next = 3;
          return getLatestNewsIds();
        case 3:
          ...
          nextIds = _.slice(newsIds, loadedNewsCount, loadedNewsCount + 10);
          loadedNews = [];
...
var _require = __webpack_require__(/*! ./components/news.component */ "./src/js/components/news.component.js"),
  getLatestNewsIds = _require.getLatestNewsIds;
var _require2 = __webpack_require__(/*! ./components/newsLoad.component */ "./src/js/components/newsLoad.component.js"),
  loadMoreNews = _require2.loadMoreNews;
